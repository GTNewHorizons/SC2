...
public class MobDeathListener {
    ...
    public void onEntityLivingDeath(LivingDeathEvent event) {
        ...
        /*
         * if (monster instanceof EntityWitch) { double rand = Math.random(); if (rand < 0.10) { dropItem(monster, new
         * ItemStack(StevesCarts.instance.component, 2, 52)); }else if(rand < 0.50){ dropItem(monster, new
         * ItemStack(StevesCarts.instance.component, 1, 52)); } }else
