...
public class BlockUpgrade extends BlockContainerBase {
    ...
    public int getRenderType() {
        return renderAsNormalBlock() || StevesCarts.instance.blockRenderer == null ? 0
                : StevesCarts.instance.blockRenderer.getRenderId();
    }
        ...
        if (tile != null && tile instanceof TileEntityUpgrade) {
            ...
            if (upgrade.getUpgrade().useStandardInterface()) {
                FMLNetworkHandler.openGui(
                        entityplayer,
                        StevesCarts.instance,
                        3,
                        world,
                        upgrade.getMaster().xCoord,
                        upgrade.getMaster().yCoord,
                        upgrade.getMaster().zCoord);
                return true;
            }
