...
public enum ModBlocks {
    ...
    ModBlocks(String name, Class<? extends IBlockBase> clazz, Class<? extends TileEntity> tileEntityClazz,
    ...
    ModBlocks(String name, Class<? extends IBlockBase> clazz, Class<? extends TileEntity> tileEntityClazz,
            String tileEntityName, Class<? extends ItemBlock> itemClazz) {
        this.name = name;
        this.clazz = clazz;
    ...
    public static void addRecipes() {
        ...
        RecipeHelper.addRecipe(
                new ItemStack(CARGO_MANAGER.block, 1),
                new Object[][] {
                        { ComponentTypes.LARGE_IRON_PANE.getItemStack(), ComponentTypes.HUGE_IRON_PANE.getItemStack(),
        ...
        // activator
        RecipeHelper.addRecipe(
                new ItemStack(MODULE_TOGGLER.block, 1),
                new Object[][] { { orange, Items.gold_ingot, blue }, { Blocks.stone, Items.iron_ingot, Blocks.stone },
                        { Items.redstone, ComponentTypes.ADVANCED_PCB.getItemStack(), Items.redstone } });

        // distributor
        RecipeHelper.addRecipe(
                new ItemStack(EXTERNAL_DISTRIBUTOR.block, 1),
                new Object[][] { { Blocks.stone, ComponentTypes.SIMPLE_PCB.getItemStack(), Blocks.stone },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Items.redstone,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { Blocks.stone, ComponentTypes.SIMPLE_PCB.getItemStack(), Blocks.stone } });

        // cart assembler
        RecipeHelper.addRecipe(
                new ItemStack(CART_ASSEMBLER.block, 1),
                new Object[][] { { Items.iron_ingot, Blocks.stone, Items.iron_ingot },
                        { Blocks.stone, Items.iron_ingot, Blocks.stone }, { ComponentTypes.SIMPLE_PCB.getItemStack(),
                                Blocks.stone, ComponentTypes.SIMPLE_PCB.getItemStack() } });

        // junction rail
        RecipeHelper.addRecipe(
                new ItemStack(JUNCTION.block, 1),
                new Object[][] { { null, Items.redstone, null }, { Items.redstone, Blocks.rail, Items.redstone },
                        { null, Items.redstone, null } });

        // adv detector rail
        RecipeHelper.addRecipe(
                new ItemStack(ADVANCED_DETECTOR.block, 2),
                new Object[][] { { Items.iron_ingot, Blocks.stone_pressure_plate, Items.iron_ingot },
        ...
        RecipeHelper.addRecipe(
                unit,
                new Object[][] { { Blocks.cobblestone, Blocks.stone_pressure_plate, Blocks.cobblestone },
        ...
        // detector manager
        RecipeHelper.addRecipe(
                new ItemStack(DETECTOR_UNIT.block, 1, 0),
                new Object[][] { { ComponentTypes.SIMPLE_PCB.getItemStack() }, { unit } });
        // detector station
        RecipeHelper.addRecipe(
                new ItemStack(DETECTOR_UNIT.block, 1, 2),
                new Object[][] { { Items.iron_ingot, Items.iron_ingot, Items.iron_ingot }, { null, unit, null },
                        { null, ComponentTypes.SIMPLE_PCB.getItemStack(), null } });
        // detector junction
        RecipeHelper.addRecipe(
                new ItemStack(DETECTOR_UNIT.block, 1, 3),
                new Object[][] { { Blocks.redstone_torch, null, Blocks.redstone_torch },
                        { Items.redstone, unit, Items.redstone },
                        { null, ComponentTypes.SIMPLE_PCB.getItemStack(), null } });
        // detector redstone
        RecipeHelper.addRecipe(
                new ItemStack(DETECTOR_UNIT.block, 1, 4),
                new Object[][] { { Items.redstone, Items.redstone, Items.redstone },
                        { Items.redstone, unit, Items.redstone }, { Items.redstone, Items.redstone, Items.redstone } });
        /** **/
        ...
        // liquid manager
        RecipeHelper.addRecipe(
                new ItemStack(LIQUID_MANAGER.block, 1),
                new Object[][] { { advtank, Items.iron_ingot, advtank },
