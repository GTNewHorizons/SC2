...
public final class ModItems {
        ...
        for (ModuleData module : ModuleData.getList().values()) {
            if (!module.getIsLocked()) {
                validModules.put(
                        ...
                        config.get(
                                "EnabledModules",
                                module.getName().replace(" ", "").replace(":", "_"),
                                module.getEnabledByDefault()).getBoolean(true));
            }
        }
    ...
    public static void addRecipes() {
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { null, Items.stick, null }, { Items.stick, planks, Items.stick },
                        { null, Items.stick, null } });

        // iron wheels
        RecipeHelper.addRecipe(
                ComponentTypes.IRON_WHEELS.getItemStack(),
                new Object[][] { { null, Items.stick, null }, { Items.stick, Items.iron_ingot, Items.stick },
                        { null, Items.stick, null } });

        // color component (RED)
        RecipeHelper.addRecipe(
                ComponentTypes.RED_PIGMENT.getItemStack(),
                new Object[][] { { null, Items.glowstone_dust, null }, { red, red, red },
                        { null, Items.glowstone_dust, null } });

        // color component (GREEN)
        RecipeHelper.addRecipe(
                ComponentTypes.GREEN_PIGMENT.getItemStack(),
                new Object[][] { { null, Items.glowstone_dust, null }, { green, green, green },
                        { null, Items.glowstone_dust, null } });

        // color component (BLUE)
        RecipeHelper.addRecipe(
                ComponentTypes.BLUE_PIGMENT.getItemStack(),
                new Object[][] { { null, Items.glowstone_dust, null }, { blue, blue, blue },
                        { null, Items.glowstone_dust, null } });

        // magic glass
        RecipeHelper.addRecipe(
                ComponentTypes.GLASS_O_MAGIC.getItemStack(),
                new Object[][] { { Blocks.glass_pane, Items.fermented_spider_eye, Blocks.glass_pane },
                        { Blocks.glass_pane, Items.redstone, Blocks.glass_pane },
                        { Blocks.glass_pane, Blocks.glass_pane, Blocks.glass_pane } });

        // fuse
        RecipeHelper.addRecipe(
                ComponentTypes.FUSE.getItemStack(12),
                new Object[][] { { Items.string }, { Items.string }, { Items.string } });

        // dynamite
        RecipeHelper.addRecipe(
                ComponentTypes.DYNAMITE.getItemStack(),
                new Object[][] { { ComponentTypes.FUSE.getItemStack() }, { Items.gunpowder }, { Items.gunpowder } });

        // pcb
        RecipeHelper.addRecipe(
                ComponentTypes.SIMPLE_PCB.getItemStack(),
                new Object[][] { { Items.iron_ingot, Items.redstone, Items.iron_ingot },
                        { Items.redstone, Items.gold_ingot, Items.redstone },
                        { Items.iron_ingot, Items.redstone, Items.iron_ingot } });
        RecipeHelper.addRecipe(
                ComponentTypes.SIMPLE_PCB.getItemStack(),
                new Object[][] { { Items.redstone, Items.iron_ingot, Items.redstone },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Items.gold_ingot, Items.diamond, Items.gold_ingot },
        ...
        // unrefined handle
        RecipeHelper.addRecipe(
                ComponentTypes.RAW_HANDLE.getItemStack(),
                new Object[][] { { null, null, Items.iron_ingot }, { null, Items.iron_ingot, null },
                        { Items.iron_ingot, null, null } });

        FurnaceRecipes.smelting().func_151394_a(
                ComponentTypes.RAW_HANDLE.getItemStack(),
                ComponentTypes.REFINED_HANDLE.getItemStack(),
                0F);

        // speed handle
        RecipeHelper.addRecipe(
                ComponentTypes.SPEED_HANDLE.getItemStack(),
                new Object[][] { { null, null, blue },
                        { Items.gold_ingot, ComponentTypes.REFINED_HANDLE.getItemStack(), null },
                        { Items.redstone, Items.gold_ingot, null } });

        // wheel
        RecipeHelper.addRecipe(
                ComponentTypes.WHEEL.getItemStack(),
                new Object[][] { { Items.iron_ingot, Items.stick, Items.iron_ingot },
                        { Items.stick, Items.iron_ingot, Items.stick }, { null, Items.stick, null } });

        // saw head
        RecipeHelper.addRecipe(
                ComponentTypes.SAW_BLADE.getItemStack(),
                new Object[][] { { Items.iron_ingot, Items.iron_ingot, Items.diamond } });
        ...
        // wood cutter
        RecipeHelper.addRecipe(
                ComponentTypes.WOOD_CUTTING_CORE.getItemStack(),
                new Object[][] { { "treeSapling", "treeSapling", "treeSapling" },
                        { "treeSapling", ComponentTypes.ADVANCED_PCB.getItemStack(), "treeSapling" },
                        { "treeSapling", "treeSapling", "treeSapling" } });

        RecipeHelper.addRecipe(
                ComponentTypes.RAW_HARDENER.getItemStack(2),
                new Object[][] { { Blocks.obsidian, null, Blocks.obsidian }, { null, Items.diamond, null },
                        { Blocks.obsidian, null, Blocks.obsidian } });

        FurnaceRecipes.smelting().func_151394_a(
                ComponentTypes.RAW_HARDENER.getItemStack(),
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Blocks.iron_bars, ComponentTypes.REFINED_HARDENER.getItemStack(), Blocks.iron_bars },
                        { ComponentTypes.REFINED_HARDENER.getItemStack(), Blocks.iron_bars,
                                ComponentTypes.REFINED_HARDENER.getItemStack() },
                        { Blocks.iron_bars, ComponentTypes.REFINED_HARDENER.getItemStack(), Blocks.iron_bars } });

        // hardened metal
        RecipeHelper.addRecipe(
                ComponentTypes.STABILIZED_METAL.getItemStack(5),
                new Object[][] { { Items.iron_ingot, ComponentTypes.HARDENED_MESH.getItemStack(), Items.iron_ingot },
        ...
        FurnaceRecipes.smelting().func_151394_a(
                ComponentTypes.STABILIZED_METAL.getItemStack(),
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { null, Items.iron_ingot, null },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Blocks.stone, Blocks.stone, Blocks.stone }, { Items.iron_ingot, null, null } });

        // shooting core
        RecipeHelper.addRecipe(
                ComponentTypes.SHOOTING_STATION.getItemStack(),
        ...
        // mob scanner
        RecipeHelper.addRecipe(
                ComponentTypes.ENTITY_SCANNER.getItemStack(),
                new Object[][] { { Items.gold_ingot, ComponentTypes.SIMPLE_PCB.getItemStack(), Items.gold_ingot },
                        { Items.redstone, ComponentTypes.ADVANCED_PCB.getItemStack(), Items.redstone },
                        { Items.redstone, null, Items.redstone } });

        // entity analyzer
        RecipeHelper.addRecipe(
                ComponentTypes.ENTITY_ANALYZER.getItemStack(),
                new Object[][] { { Items.iron_ingot, Items.redstone, Items.iron_ingot },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Items.redstone }, { ComponentTypes.SIMPLE_PCB.getItemStack() } });
        ...
        // chest thingy
        RecipeHelper.addRecipe(
                ComponentTypes.CHEST_PANE.getItemStack(32),
                new Object[][] { { planks, planks, planks }, { wood, planks, wood }, { planks, planks, planks } });

        // big chest thingy
        RecipeHelper.addRecipe(
                ComponentTypes.LARGE_CHEST_PANE.getItemStack(),
                new Object[][] { { ComponentTypes.CHEST_PANE.getItemStack(), ComponentTypes.CHEST_PANE.getItemStack() },
        ...
        // large chest thingy
        RecipeHelper.addRecipe(
                ComponentTypes.CHEST_LOCK.getItemStack(8),
                new Object[][] { { Items.iron_ingot }, { Blocks.stone } });
        RecipeHelper.addRecipe(
                ComponentTypes.CHEST_LOCK.getItemStack(8),
        ...
        // iron chest thingy
        RecipeHelper.addRecipe(
                ComponentTypes.IRON_PANE.getItemStack(8),
                new Object[][] {
                        { ComponentTypes.CHEST_PANE.getItemStack(), ComponentTypes.CHEST_PANE.getItemStack(),
                                ComponentTypes.CHEST_PANE.getItemStack() },
                        { ComponentTypes.CHEST_PANE.getItemStack(), Items.iron_ingot,
                                ComponentTypes.CHEST_PANE.getItemStack() },
                        { ComponentTypes.CHEST_PANE.getItemStack(), ComponentTypes.CHEST_PANE.getItemStack(),
                                ComponentTypes.CHEST_PANE.getItemStack() } });
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { ComponentTypes.IRON_PANE.getItemStack(), ComponentTypes.IRON_PANE.getItemStack() },
        ...
        RecipeHelper.addRecipe(
                ComponentTypes.DYNAMIC_PANE.getItemStack(),
                new Object[][] { { ComponentTypes.IRON_PANE.getItemStack() }, { Items.redstone } });
        RecipeHelper.addRecipe(
                ComponentTypes.DYNAMIC_PANE.getItemStack(),
                new Object[][] { { Items.redstone }, { ComponentTypes.IRON_PANE.getItemStack() } });

        // big dynamic chest thingy
        RecipeHelper.addRecipe(
                ComponentTypes.LARGE_DYNAMIC_PANE.getItemStack(),
                new Object[][] { { null, ComponentTypes.DYNAMIC_PANE.getItemStack(), null },
                        { ComponentTypes.DYNAMIC_PANE.getItemStack(), Items.redstone,
                                ComponentTypes.DYNAMIC_PANE.getItemStack() },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] {
                        { ComponentTypes.DYNAMIC_PANE.getItemStack(), ComponentTypes.DYNAMIC_PANE.getItemStack(),
                                ComponentTypes.DYNAMIC_PANE.getItemStack() },
                        { ComponentTypes.DYNAMIC_PANE.getItemStack(), ComponentTypes.SIMPLE_PCB.getItemStack(),
                                ComponentTypes.DYNAMIC_PANE.getItemStack() },
                        { ComponentTypes.DYNAMIC_PANE.getItemStack(), ComponentTypes.DYNAMIC_PANE.getItemStack(),
                                ComponentTypes.DYNAMIC_PANE.getItemStack() } });
        ...
        // cleaning fan
        RecipeHelper.addRecipe(
                ComponentTypes.CLEANING_FAN.getItemStack(),
                new Object[][] { { Blocks.iron_bars, Items.redstone, Blocks.iron_bars },
                        { Items.redstone, null, Items.redstone },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] {
                        { ComponentTypes.CLEANING_FAN.getItemStack(), Items.iron_ingot,
                                ComponentTypes.CLEANING_FAN.getItemStack() },
                        { ComponentTypes.CLEANING_TUBE.getItemStack(), ComponentTypes.CLEANING_TUBE.getItemStack(),
                                ComponentTypes.CLEANING_TUBE.getItemStack() },
                        { Items.iron_ingot, ComponentTypes.CLEANING_TUBE.getItemStack(), Items.iron_ingot } });

        // cleaning tube
        RecipeHelper.addRecipe(
                ComponentTypes.CLEANING_TUBE.getItemStack(2),
                new Object[][] { { orange, Items.iron_ingot, orange }, { orange, Items.iron_ingot, orange },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Items.glowstone_dust, Items.redstone },
                        { Items.iron_ingot, Items.glowstone_dust } });

        // magic thingy
        RecipeHelper.addRecipe(
                ComponentTypes.EYE_OF_GALGADOR.getItemStack(),
                new Object[][] { { Items.magma_cream, Items.fermented_spider_eye, Items.magma_cream },
                        { Items.ghast_tear, Items.ender_eye, Items.ghast_tear },
                        { Items.magma_cream, Items.fermented_spider_eye, Items.magma_cream } });

        // magic metal
        RecipeHelper.addRecipe(
                ComponentTypes.LUMP_OF_GALGADOR.getItemStack(2),
                new Object[][] { { Items.glowstone_dust, Blocks.diamond_block, Items.glowstone_dust },
                        { ComponentTypes.EYE_OF_GALGADOR.getItemStack(), Items.glowstone_dust,
                                ComponentTypes.EYE_OF_GALGADOR.getItemStack() },
                        { ComponentTypes.STABILIZED_METAL.getItemStack(), ComponentTypes.EYE_OF_GALGADOR.getItemStack(),
                                ComponentTypes.STABILIZED_METAL.getItemStack() } });

        FurnaceRecipes.smelting().func_151394_a(
                ComponentTypes.LUMP_OF_GALGADOR.getItemStack(),
                ComponentTypes.GALGADORIAN_METAL.getItemStack(),
                0F);

        RecipeHelper.addRecipe(
                ComponentTypes.LARGE_LUMP_OF_GALGADOR.getItemStack(),
                new Object[][] {
                        { ComponentTypes.LUMP_OF_GALGADOR.getItemStack(),
                                ComponentTypes.LUMP_OF_GALGADOR.getItemStack(),
                                ComponentTypes.LUMP_OF_GALGADOR.getItemStack() },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Items.string, Items.string, Items.string }, { Items.string, red, Items.string },
                        { Items.string, Items.string, Items.string } });

        RecipeHelper.addRecipe(
                ComponentTypes.YELLOW_GIFT_RIBBON.getItemStack(),
                new Object[][] { { Items.string, Items.string, Items.string }, { Items.string, yellow, Items.string },
                        { Items.string, Items.string, Items.string } });

        RecipeHelper.addRecipe(
                ComponentTypes.WARM_HAT.getItemStack(),
                new Object[][] { { null, new ItemStack(Blocks.wool, 1, 14), new ItemStack(Blocks.wool, 1, 0) },
                        { new ItemStack(Blocks.wool, 1, 14), Items.diamond, new ItemStack(Blocks.wool, 1, 14) },
                        { new ItemStack(Blocks.wool, 1, 14), new ItemStack(Blocks.wool, 1, 14),
                                new ItemStack(Blocks.wool, 1, 14) } });

        RecipeHelper.addRecipe(
                ComponentTypes.SOCK.getItemStack(),
                new Object[][] { { new ItemStack(Blocks.wool, 1, 14), new ItemStack(Blocks.wool, 1, 14), Items.cookie },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] {
                        ...
                        { Items.iron_ingot, ComponentTypes.SIMPLE_PCB.getItemStack(), Items.iron_ingot },
                        { ComponentTypes.SOLAR_PANEL.getItemStack(), null,
                                ComponentTypes.SOLAR_PANEL.getItemStack() } });
        RecipeHelper.addRecipe(
                ComponentTypes.ADVANCED_SOLAR_PANEL.getItemStack(),
                new Object[][] {
        ...
        RecipeHelper.addRecipe(
                ComponentTypes.BLANK_UPGRADE.getItemStack(2),
                new Object[][] { { Items.iron_ingot, Items.iron_ingot, Items.iron_ingot },
                        { ComponentTypes.REINFORCED_METAL.getItemStack(), Items.redstone,
                                ComponentTypes.REINFORCED_METAL.getItemStack() },
                        { Items.iron_ingot, ComponentTypes.ADVANCED_PCB.getItemStack(), Items.iron_ingot } });

        // valve
        RecipeHelper.addRecipe(
                ComponentTypes.TANK_VALVE.getItemStack(8),
                new Object[][] { { null, Items.iron_ingot, null },
                        { Items.iron_ingot, Blocks.iron_bars, Items.iron_ingot }, { null, Items.iron_ingot, null } });

        // tank pane
        RecipeHelper.addRecipe(
                ComponentTypes.TANK_PANE.getItemStack(32),
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { ComponentTypes.TANK_PANE.getItemStack(), ComponentTypes.TANK_PANE.getItemStack() },
        ...
        // cleaning tube
        RecipeHelper.addRecipe(
                ComponentTypes.LIQUID_CLEANING_TUBE.getItemStack(2),
                new Object[][] { { green, Items.iron_ingot, green }, { green, Items.iron_ingot, green },
                        { green, Items.iron_ingot, green } });

        // Easter Eggs, really, Eggs you paint at Easter. Those kind of Easter Eggs.

        RecipeHelper.addRecipe(
                ComponentTypes.EXPLOSIVE_EASTER_EGG.getItemStack(),
                new Object[][] { { Items.gunpowder, Items.gunpowder, Items.gunpowder },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { Items.blaze_powder, Items.blaze_rod, Items.blaze_powder },
                        { Items.blaze_powder, Items.egg, Items.blaze_powder }, { red, Items.magma_cream, yellow } });

        RecipeHelper.addRecipe(
                ComponentTypes.GLISTERING_EASTER_EGG.getItemStack(),
                new Object[][] { { Items.gold_nugget, Items.gold_nugget, Items.gold_nugget },
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { chocolate, Items.sugar, chocolate }, { chocolate, Items.egg, chocolate },
                        { chocolate, Items.sugar, chocolate } });

        RecipeHelper.addRecipe(
                ComponentTypes.BASKET.getItemStack(),
                new Object[][] { { Items.stick, Items.stick, Items.stick }, { Items.stick, null, Items.stick },
        ...
        for (int i = 0; i < 4; i++) {
            RecipeHelper.addRecipe(
                    ...
                    new Object[][] { { ItemCartComponent.getWood(i, true) } });

            RecipeHelper.addRecipe(
                    new ItemStack(Items.stick, 2),
                    new Object[][] { { ItemCartComponent.getWood(i, false) } });
        }
        ...
        RecipeHelper.addRecipe(
                ...
                new Object[][] { { null, ComponentTypes.REINFORCED_METAL.getItemStack(), null },
                        { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                ComponentTypes.GALGADORIAN_METAL.getItemStack(),
                                ComponentTypes.REINFORCED_METAL.getItemStack() },
        ...
        // iron blade
        RecipeHelper.addRecipe(
                ComponentTypes.IRON_BLADE.getItemStack(4),
                new Object[][] { { null, Items.shears, null }, { Items.iron_ingot, Items.iron_ingot, Items.iron_ingot },
                        { null, Items.iron_ingot, null } });
