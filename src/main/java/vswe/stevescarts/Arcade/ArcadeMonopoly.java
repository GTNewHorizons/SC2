...
public class ArcadeMonopoly extends ArcadeGame {
    ...
    public ArcadeMonopoly(ModuleArcade module) {
        ...
        places = new Place[] { new Go(this), new Street(this, streetGroup1, "Soaryn Chest", 30, 2), new Community(this),
                new Street(this, streetGroup1, "Eddie's Cobble Stairs", 30, 2), new Place(this),
                new Utility(this, utilGroup, 0, "Test"), new Street(this, streetGroup2, "Ecu's Eco Escape", 60, 4),
                new Station(this, stationGroup, 0, "Wooden Station"), new Street(this, streetGroup2, "Test", 60, 4),
                new Villager(this), new Street(this, streetGroup3, "Direwolf's 9x9", 100, 6), new Chance(this),
                new Street(this, streetGroup3, "Greg's Forest", 100, 6),
                new Street(this, streetGroup3, "Alice's Tunnel", 110, 8), new Jail(this),
                new Street(this, streetGroup4, "Flora's Alveary", 140, 10), new Utility(this, utilGroup, 1, "Test"),
                new Street(this, streetGroup4, "Sengir's Greenhouse", 140, 10),
                new Street(this, streetGroup4, "Test", 160, 12), new Station(this, stationGroup, 1, "Standard Station"),
                new Street(this, streetGroup5, "Muse's Moon Base", 200, 14), new Community(this),
                new Street(this, streetGroup5, "Algorithm's Crafting CPU", 200, 14),
                new Street(this, streetGroup5, "Pink Lemmingaide Stand", 240, 16), new CornerPlace(this, 2),
                new Street(this, streetGroup6, "Covert's Railyard", 250, 18), new Chance(this),
                new Street(this, streetGroup6, "Test", 250, 18), new Street(this, streetGroup6, "Test", 270, 20),
                new Community(this), new Street(this, streetGroup6, "Test", 270, 20),
                new Station(this, stationGroup, 2, "Reinforced Station"),
                new Street(this, streetGroup7, "Player's Industrial Warehouse", 320, 22), new Villager(this),
                new Street(this, streetGroup7, "Dan's Computer Repair", 320, 22),
                new Street(this, streetGroup7, "iChun's Hat Shop", 350, 24), new Utility(this, utilGroup, 2, "Test"),
                new Street(this, streetGroup7, "Lex's Forge", 350, 24), new GoToJail(this),
                new Street(this, streetGroup8, "Morvelaira's Pretty Wall", 400, 26),
                new Street(this, streetGroup8, "Rorax's Tower of Doom", 400, 26), new Community(this),
                new Street(this, streetGroup8, "Jaded's Crash Lab", 440, 30),
                new Station(this, stationGroup, 3, "Galgadorian Station"), new Chance(this),
                new Street(this, streetGroup9, "Test", 500, 40), new Place(this),
        ...
        /*
         * for (int i = 0; i < pieces.size(); i++) { pieces.get(i).goToJail(); pieces.get(i).releaseFromJail(); }
         */
        ...
        buttons.add(purchase = new Button() {
            ...
            @Override
            public boolean isVisible() {
                return controllable && places[getCurrentPiece().getPosition()] instanceof Property
                        && !((Property) places[getCurrentPiece().getPosition()]).hasOwner();
            }
        ...
        buttons.add(bed = new Button() {
            ...
            public boolean isEnabled() {
                ...
                return controllable && street.ownsAllInGroup(getCurrentPiece())
                        && street.getStructureCount() < 5
                        && getCurrentPiece().canAffordStructure(street)
                        && !street.isMortgaged();
            }
        ...
        buttons.add(card = new Button() {
            ...
            @Override
            public boolean isVisible() {
                return controllable && places[getCurrentPiece().getPosition()] instanceof CardPlace
                        && (!openedCard || currentCard != null);
            }
        ...
        buttons.add(mortgage = new Button() {
            ...
            @Override
            public boolean isVisible() {
                return controllable && getSelectedPlace() != null
                        && getSelectedPlace() instanceof Property
                        && ((Property) getSelectedPlace()).getOwner() == getCurrentPiece()
                        && !((Property) getSelectedPlace()).isMortgaged();
            }
    ...
    public void drawBackground(GuiMinecart gui, int x, int y) {
        ...
        float smallgridX = x / SCALE
                - ((MinecartModular.MODULAR_SPACE_WIDTH / SCALE) - (PLACE_HEIGHT * 2 + (BOARD_WIDTH - 1) * PLACE_WIDTH))
                        / 2;
        float smallgridY = y / SCALE - ((MinecartModular.MODULAR_SPACE_HEIGHT / SCALE)
                - (PLACE_HEIGHT * 2 + (BOARD_HEIGHT - 1) * PLACE_WIDTH)) / 2;

        boolean foundHover = false;

        if (selectedPlace != -1) {
            drawPropertyOnBoardWithPositionRotationAndScale(
                    gui,
                    places[selectedPlace],
                    selectedPlace,
                    true,
                    false,
                    (int) ((MinecartModular.MODULAR_SPACE_WIDTH / 0.75
                            - ((getId(selectedPlace) == 0) ? PLACE_HEIGHT : PLACE_WIDTH)) / 2),
                    (int) ((MinecartModular.MODULAR_SPACE_HEIGHT / 0.75 - PLACE_HEIGHT) / 2),
                    0,
                    0.75F);
        }
            ...
            if (!foundHover && getModule().inRect((int) smallgridX, (int) smallgridY, getSmallgridPlaceArea(i))) {
                if (selectedPlace == -1) {
                    drawPropertyOnBoardWithPositionRotationAndScale(
                            ...
                            false,
                            (int) ((MinecartModular.MODULAR_SPACE_WIDTH / 0.75
                                    - ((getId(i) == 0) ? PLACE_HEIGHT : PLACE_WIDTH)) / 2),
                            (int) ((MinecartModular.MODULAR_SPACE_HEIGHT / 0.75 - PLACE_HEIGHT) / 2),
                            0,
                            0.75F);
                }
        ...
        for (int i = 0; i < pieces.size(); i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                switch (j) {
                    case 0:
                        v = piece.getController() == Piece.CONTROLLED_BY.PLAYER ? 0
                                : piece.getController() == Piece.CONTROLLED_BY.COMPUTER ? 1 : 2;
                        break;
                    case 1:
                        v = pieces.get(i).isBankrupt() ? 4
                                : currentPiece == i ? diceCount == 0 ? diceTimer > 0 ? 3 : 2 : 1 : 0;
                        break;
                    case 2:
                        v = getSelectedPlace() != null && getSelectedPlace() instanceof Property
                                && ((Property) getSelectedPlace()).getOwner() == pieces.get(i)
                                        ? ((Property) getSelectedPlace()).isMortgaged() ? 2 : 1
                                        : 0;
                        break;
                }
            ...
            for (int j = piece.getAnimationNotes().size() - 1; j >= 0; j--) {
                ...
                if (animX + 16 > MinecartModular.MODULAR_SPACE_WIDTH) {
            ...
            if (getSelectedPlace() instanceof Street) {
                ...
                if (street.getOwner() != null && !street.isMortgaged()) {
                    if (street.getStructureCount() == 0) {
                        getModule().drawImage(
                                gui,
                                7,
                                street.ownsAllInGroup(street.getOwner()) ? 241 : 226,
                                PLACE_WIDTH + 48,
                                22,
                                5,
                                10);
                        ...
                        getModule().drawImage(
                                gui,
                                323,
                                172 + (street.getStructureCount() - 1) * 17,
                                PLACE_WIDTH + 48,
                                22,
                                5,
                                10);
                ...
                if (station.getOwner() != null && !station.isMortgaged()) {
                    getModule().drawImage(
                            gui,
                            323,
                            184 + (station.getOwnedInGroup() - 1) * 17,
                            PLACE_WIDTH + 48,
                            22,
                            5,
                            10);
                ...
                if (utility.getOwner() != null && !utility.isMortgaged()) {
                    getModule().drawImage(
                            gui,
                            323,
                            184 + (utility.getOwnedInGroup() - 1) * 17,
                            PLACE_WIDTH + 48,
                            22,
                            5,
                            10);
    ...
    private void drawCard(GuiMinecart gui, boolean isFront) {
        ...
        int x = (MinecartModular.MODULAR_SPACE_WIDTH - CARD_WIDTH) / 2;
        int y = (MinecartModular.MODULAR_SPACE_HEIGHT - CARD_HEIGHT) / 2;
        ...
        if (getSelectedPlace() != null) {
            if (getSelectedPlace() instanceof Street) {
                ...
                getModule().drawSplitString(
                        gui,
                        "The rent depends on the eye count of the dice, if you own one Utility it's "
                                + Utility.getMultiplier(1)
                                + "x the eye count, if you own two it's "
                                + Utility.getMultiplier(2)
                                + "x and if you own them all it's "
                                + Utility.getMultiplier(3)
                                + "x.",
                        10,
                        195,
                        145,
    ...
    private int[] getSmallgridPlaceArea(int id) {
        ...
        if (i == 0) {
            switch (side) {
                case 0:
                    return new int[] { PLACE_HEIGHT + PLACE_WIDTH * (BOARD_WIDTH - 1),
                            PLACE_HEIGHT + PLACE_WIDTH * (BOARD_HEIGHT - 1), PLACE_HEIGHT, PLACE_HEIGHT };
                case 1:
            ...
            switch (side) {
                case 0:
                    return new int[] { PLACE_HEIGHT + ((BOARD_WIDTH - 1) - i) * PLACE_WIDTH - PLACE_WIDTH,
                            PLACE_HEIGHT + (BOARD_HEIGHT - 1) * PLACE_WIDTH, PLACE_WIDTH, PLACE_HEIGHT };
                case 1:
                    return new int[] { 0, PLACE_HEIGHT + ((BOARD_HEIGHT - 1) - i) * PLACE_WIDTH - PLACE_WIDTH,
                            PLACE_HEIGHT, PLACE_WIDTH };
                case 2:
                    return new int[] { PLACE_HEIGHT + i * PLACE_WIDTH, 0, PLACE_WIDTH, PLACE_HEIGHT };
                default:
                case 3:
                    return new int[] { PLACE_HEIGHT + (BOARD_WIDTH - 1) * PLACE_WIDTH, PLACE_HEIGHT + i * PLACE_WIDTH,
                            PLACE_HEIGHT, PLACE_WIDTH };
            }
        }
    ...
    private void drawPropertyOnBoard(GuiMinecart gui, Place place, int id, int side, int i, boolean hover) {
        ...
        offX += ((int) (MinecartModular.MODULAR_SPACE_WIDTH / SCALE)
                - (PLACE_HEIGHT * 2 + (BOARD_WIDTH - 1) * PLACE_WIDTH)) / 2;
        offY += ((int) (MinecartModular.MODULAR_SPACE_HEIGHT / SCALE)
                - (PLACE_HEIGHT * 2 + (BOARD_HEIGHT - 1) * PLACE_WIDTH)) / 2;
    ...
    private void drawPropertyOnBoardWithPositionRotationAndScale(GuiMinecart gui, Place place, int id, boolean zoom,
            boolean hover, int x, int y, int r, float s) {
        GL11.glPushMatrix();
    ...
    public void mouseClicked(GuiMinecart gui, int x, int y, int b) {
        ...
        if (currentCard != null && cardScale == 1F) {
            int[] rect = new int[] { (MinecartModular.MODULAR_SPACE_WIDTH - CARD_WIDTH) / 2,
                    (MinecartModular.MODULAR_SPACE_HEIGHT - CARD_HEIGHT) / 2, CARD_WIDTH, CARD_HEIGHT };
