...
public abstract class ArcadeGame {
    ...
    public void drawImageInArea(GuiMinecart gui, int x, int y, int u, int v, int w, int h) {
        drawImageInArea(
                ...
                5,
                4,
                MinecartModular.MODULAR_SPACE_WIDTH,
                MinecartModular.MODULAR_SPACE_HEIGHT);
    }

    public void drawImageInArea(GuiMinecart gui, int x, int y, int u, int v, int w, int h, int x1, int y1, int x2,
            int y2) {
        if (x < x1) {
            w -= x1 - x;
            u += x1 - x;
