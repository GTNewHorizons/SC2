...
public abstract class CardChance extends Card {
    ...
    static {
        ...
        cards.add(
                new CardChance(
                        "Jaded managed to crash the server, again. The server had to roll back. Go 3 steps back.") {
        ...
        cards.add(
                new CardChance(
                        "You found a linking book in the middle of nowhere and foolishly you used it. You shouldn't have done that, now you're trapped in a void age.") {
