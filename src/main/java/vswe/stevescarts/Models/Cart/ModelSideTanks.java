...
public class ModelSideTanks extends ModelCartbase {
    ...
    public void render(Render render, ModuleBase module, float yaw, float pitch, float roll, float mult,
        ...
        if (render != null && module != null) {
            ...
            if (liquid != null) {
                ((RendererMinecart) render).renderLiquidCuboid(
                        liquid,
                        ((ModuleTank) module).getCapacity(),
                        -2,
                        -0.5F,
                        -11,
                        10,
                        ...
                        4,
                        mult);
                ((RendererMinecart) render)
                        .renderLiquidCuboid(liquid, ((ModuleTank) module).getCapacity(), -2, -0.5F, 11, 10, 4, 4, mult);
            }
        }
    }
}
