...
public class ModelPigTail extends ModelCartbase {
    ...
    public ModelPigTail() {
        ...
        tailanchor.setRotationPoint(10.0F, -4, 0F);
        ...
        tail3.setRotationPoint(0.5F, -4, 0F);
        ...
        tail5.setRotationPoint(0, -2, 0F);
    }

    public void render(Render render, ModuleBase module, float yaw, float pitch, float roll, float mult,
            float partialtime) {
        if (module != null) {
