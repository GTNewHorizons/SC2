...
public class ModelSideGuns extends ModelCartbase {
    ...
    private ModelRenderer[] createSide(boolean opposite) {
        ...
        return new ModelRenderer[] { handle, base, gun, back, backAttacher, stabalizer, missileStands[0],
                missileStands[1], missileStands[2], missileStands[3], missileStands[4], missileStands[5], missleArmBase,
                missleArm, missleArmBaseFake, missleArmFake, missiles[0], missiles[1] };
    }
