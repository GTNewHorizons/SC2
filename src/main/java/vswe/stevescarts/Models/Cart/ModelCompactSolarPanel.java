...
public class ModelCompactSolarPanel extends ModelCartbase {
    ...
    private ModelRenderer[] createSide(boolean opposite) {
        ...
        return new ModelRenderer[] { panelBase, panelTop, panelBot, panelLeft, panelRight, panelTopLeft, panelTopRight,
                panelBotLeft, panelBotRight, panelarmouter, panelarminner };
    }

    private ModelRenderer createPanel(ModelRenderer parent, int width, int height, float offset, int textureOffsetX,
            int textureOffsetY) {
