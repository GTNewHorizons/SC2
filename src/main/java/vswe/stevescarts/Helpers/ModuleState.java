...
public class ModuleState {
    ...
    public ModuleState(int id, Class<? extends ModuleBase> moduleClass, Localization.GUI.DETECTOR name,
            STATETYPE type) {
    ...
    public boolean evaluate(MinecartModular cart) {
        ...
        switch (type) {
            ...
            case PASSENGER:
                ...
                if (passenger != null) {
                    return ((ModuleStatePassenger) this).passengerClass.isAssignableFrom(passenger.getClass())
                            && ((ModuleStatePassenger) this).isPassengerValid(passenger);
                }
