...
public class TradeHandler implements VillagerRegistry.IVillageTradeHandler {
    ...
    /**
     * Called to allow changing the content of the {@link MerchantRecipeList} for the villager supplied during creation
     *
     * @param villager
     * @param recipeList
     */
    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
        recipeList.add(
                new MerchantRecipe(new ItemStack(ModItems.component, 3, 50), new ItemStack(ModItems.component, 1, 51)));
    }
