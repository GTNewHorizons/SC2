...
public enum DetectorType {
    ...
    NORMAL(0, true, false, true, "detector_manager_bot", "detector_manager_top", "detector_manager_yellow",
            "detector_manager_blue", "detector_manager_green", "detector_manager_red"),

    UNIT(1, false, false, false, "detector_manager_bot", "detector_manager_bot", "detector_unit_yellow",
            "detector_unit_blue", "detector_unit_green", "detector_unit_red"),

    STOP(2, true, true, false, "detector_manager_bot", "detector_station_top", "detector_station_yellow",
            "detector_station_blue", "detector_station_green", "detector_station_red") {
    ...
    JUNCTION(3, true, false, false, "detector_manager_bot", "detector_junction_top", "detector_junction_yellow",
            "detector_junction_blue", "detector_junction_green", "detector_junction_red") {
        ...
        private void update(TileEntityDetector detector, boolean flag) {
            if (detector.getWorldObj().getBlock(detector.xCoord, detector.yCoord + 1, detector.zCoord)
                    == ModBlocks.ADVANCED_DETECTOR.getBlock()) {
                ((BlockRailAdvDetector) ModBlocks.ADVANCED_DETECTOR.getBlock()).refreshState(
                        detector.getWorldObj(),
                        detector.xCoord,
                        detector.yCoord + 1,
                        detector.zCoord,
                        flag);
    ...
    REDSTONE(4, false, false, false, "detector_redstone_bot", "detector_redstone_bot", "detector_redstone_yellow",
            "detector_redstone_blue", "detector_redstone_green", "detector_redstone_red") {
        ...
        public void initOperators(HashMap<Byte, OperatorObject> operators) {
            ...
            new OperatorObject.OperatorObjectRedstone(
                    operators,
                    14,
                    Localization.GUI.DETECTOR.REDSTONE_NORTH,
                    0,
                    0,
                    -1);
    ...
    public String getName() {
        return StatCollector
                .translateToLocal("item." + StevesCarts.instance.localStart + "BlockDetector" + meta + ".name");
    }
