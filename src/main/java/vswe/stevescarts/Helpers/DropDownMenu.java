...
public class DropDownMenu {
    ...
    public void drawMain(GuiDetector gui, int x, int y) {
        ...
        gui.drawTexturedModalRect(
                gui.getGuiLeft() + rect[0],
                gui.getGuiTop() + rect[1],
                0,
                SCROLL_HEIGHT - SCROLL_HEADER_HEIGHT - moduleScroll,
                rect[2],
                rect[3]);
    }
    ...
    public void drawHeader(GuiDetector gui) {
        ...
        gui.drawTexturedModalRect(
                ...
                gui.getGuiTop() + rect[1],
                (232 / TAB_COUNT) * index,
                SCROLL_HEIGHT - SCROLL_HEADER_HEIGHT,
                rect[2],
                rect[3]);
    }
    ...
    public int[] getHeaderRect() {
        return new int[] { 11 + (232 / TAB_COUNT) * index, SCROLL_TOP_MARGIN + moduleScroll,
                (int) Math.ceil(232F / TAB_COUNT), SCROLL_HEADER_HEIGHT };
    }
