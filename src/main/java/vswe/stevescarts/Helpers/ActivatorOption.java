...
public class ActivatorOption {
    ...
    public String getInfo() {
        if (isDisabled()) {
            ...
            return "\u00a76" + Localization.GUI.TOGGLER.SETTING_ORANGE.translate()
                    + ": "
                    + (shouldActivate(true) ? "\u00a72" + Localization.GUI.TOGGLER.STATE_ACTIVATE.translate()
                            : shouldDeactivate(true) ? "\u00a74" + Localization.GUI.TOGGLER.STATE_DEACTIVATE.translate()
                                    : "\u00a7E" + Localization.GUI.TOGGLER.STATE_TOGGLE.translate())
                    + "\n"
                    + "\u00a71"
                    + Localization.GUI.TOGGLER.SETTING_BLUE.translate()
                    + ": "
