...
public class OperatorObject {
    ...
    static {
        ...
        new OperatorObject(operators, 0, Localization.GUI.DETECTOR.OUTPUT, 1) {
            ...
            public boolean evaluate(TileEntityDetector detector, MinecartModular cart, int depth, LogicObject A,
                    LogicObject B) {
        ...
        // Note that IDs are also used by the specific types, the next ID here shouldn't be 11, that one is already in
        // use.
    ...
    public static class OperatorObjectRedirector extends OperatorObject {
        ...
        public OperatorObjectRedirector(HashMap<Byte, OperatorObject> operators, int ID, Localization.GUI.DETECTOR name,
                int x, int y, int z) {
    ...
    public static class OperatorObjectRedstone extends OperatorObject {
        ...
        public OperatorObjectRedstone(HashMap<Byte, OperatorObject> operators, int ID, Localization.GUI.DETECTOR name,
                int x, int y, int z) {
            super(operators, ID, name, 0);
