...
public abstract class GuiNEIKiller extends GuiScreen {
    ...
    private void drawItemStack(ItemStack p_146982_1_, int p_146982_2_, int p_146982_3_, String p_146982_4_) {
        ...
        itemRender.renderItemOverlayIntoGUI(
                ...
                p_146982_1_,
                p_146982_2_,
                p_146982_3_ - (this.draggedStack == null ? 0 : 8),
                p_146982_4_);
        this.zLevel = 0.0F;
    ...
    private void func_146977_a(Slot p_146977_1_) {
        ...
        if (p_146977_1_ == this.clickedSlot && this.draggedStack != null
    ...
    protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_) {
        ...
        int l = this.guiLeft;
        int i1 = this.guiTop;
        boolean flag = p_146286_1_ < l || p_146286_2_ < i1
                || p_146286_1_ >= l + this.xSize
    ...
    protected void handleMouseClick(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_) {
        ...
        this.mc.playerController
                .windowClick(this.inventorySlots.windowId, p_146984_2_, p_146984_3_, p_146984_4_, this.mc.thePlayer);
    }
