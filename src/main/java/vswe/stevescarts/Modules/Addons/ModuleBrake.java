...
public class ModuleBrake extends ModuleAddon implements ILeverModule {
    ...
    private int[] turnbackRect = new int[] { startstopRect[0] + startstopRect[2] + 5, startstopRect[1],
            startstopRect[2], startstopRect[3] };
    ...
    public void drawMouseOver(GuiMinecart gui, int x, int y) {
        drawStringOnMouseOver(
                gui,
                isForceStopping() ? Localization.MODULES.ADDONS.LEVER_START.translate()
                        : Localization.MODULES.ADDONS.LEVER_STOP.translate(),
                x,
                y,
                startstopRect);
