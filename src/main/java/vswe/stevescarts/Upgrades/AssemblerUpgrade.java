...
public class AssemblerUpgrade {
    ...
    public static void init() {
        ...
        AssemblerUpgrade batteries = new AssemblerUpgrade(0, "Batteries").addEffect(new FuelCapacity(5000))
                .addEffect(new Recharger(40)).addRecipe(
                        new Object[][] { { Items.redstone, Items.redstone, Items.redstone },
        ...
        new AssemblerUpgrade(1, "Power Crystal").addEffect(new FuelCapacity(15000)).addEffect(new Recharger(150))
                .addRecipe(
                        new Object[][] { { Items.diamond, Items.glowstone_dust, Items.diamond },
                                { Items.glowstone_dust, Blocks.emerald_block, Items.glowstone_dust },
                                { Items.diamond, batteries.getItemStack(), Items.diamond } });

        AssemblerUpgrade knowledge = new AssemblerUpgrade(2, "Module knowledge").addEffect(new TimeFlat(-750))
                .addEffect(new TimeFlatCart(-5000)).addEffect(new WorkEfficiency(-0.01F)).addRecipe(
                        new Object[][] { { Items.book, Blocks.bookshelf, Items.book },
                                { Blocks.bookshelf, Blocks.enchanting_table, Blocks.bookshelf },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ComponentTypes.BLANK_UPGRADE.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } });

        new AssemblerUpgrade(3, "Industrial espionage").addEffect(new TimeFlat(-2500))
                .addEffect(new TimeFlatCart(-14000)).addEffect(new WorkEfficiency(-0.01F)).addRecipe(
                        new Object[][] {
                                ...
                                { ComponentTypes.EYE_OF_GALGADOR.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ComponentTypes.EYE_OF_GALGADOR.getItemStack() },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(), knowledge.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } });
        ...
        AssemblerUpgrade experienced = new AssemblerUpgrade(4, "Experienced assembler")
                .addEffect(new WorkEfficiency(0.10F)).addEffect(new FuelCost(0.3F))
                .addRecipe(
                        new Object[][] {
                                { ComponentTypes.SIMPLE_PCB.getItemStack(), books[0],
                                ...
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ...
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } })
                .addRecipe(
                        new Object[][] { { Items.redstone, books[1], Items.redstone },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ComponentTypes.ADVANCED_PCB.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack() },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ...
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } })
                .addRecipe(
                        new Object[][] { { Items.redstone, books[2], Items.redstone },
                                { Items.iron_ingot, ComponentTypes.ADVANCED_PCB.getItemStack(), Items.iron_ingot },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ComponentTypes.BLANK_UPGRADE.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } })
                .addRecipe(
                        new Object[][] { { null, books[3], null },
                                { Items.iron_ingot, ComponentTypes.SIMPLE_PCB.getItemStack(), Items.iron_ingot },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(),
                                        ComponentTypes.BLANK_UPGRADE.getItemStack(),
                                        ComponentTypes.REINFORCED_METAL.getItemStack() } })
                .addRecipe(
                        new Object[][] { { null, books[4], null }, { null, Items.redstone, null },
                                { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(5, "New Era").addEffect(new WorkEfficiency(1.00F)).addEffect(new FuelCost(30.00F))
                .addRecipe(
                        new Object[][] {
                                { ComponentTypes.GALGADORIAN_METAL.getItemStack(), books[4],
                                        ComponentTypes.GALGADORIAN_METAL.getItemStack() },
                                { ComponentTypes.GALGADORIAN_METAL.getItemStack(), ComponentTypes.ADVANCED_PCB,
                                        ComponentTypes.GALGADORIAN_METAL.getItemStack() },
                                { ComponentTypes.GALGADORIAN_METAL.getItemStack(), experienced.getItemStack(),
                                        ComponentTypes.GALGADORIAN_METAL.getItemStack() } });

        new AssemblerUpgrade(6, "CO2 friendly").addEffect(new FuelCost(-0.15F)).addRecipe(
                new Object[][] { { null, Blocks.piston, null },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Blocks.fence,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { ComponentTypes.CLEANING_FAN, ComponentTypes.BLANK_UPGRADE.getItemStack(),
                                ComponentTypes.CLEANING_FAN } });

        new AssemblerUpgrade(7, "Generic engine").addEffect(new CombustionFuel()).addEffect(new FuelCost(0.05F))
                .addRecipe(
                        new Object[][] { { null, ComponentTypes.SIMPLE_PCB.getItemStack(), null },
                                { Blocks.piston, Blocks.furnace, Blocks.piston },
                                { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(8, "Module input", 1).addEffect(new InputChest(7, 3)).addRecipe(
                new Object[][] { { null, ComponentTypes.ADVANCED_PCB.getItemStack(), null },
                        { Blocks.piston, Blocks.chest, Blocks.piston },
                        { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(9, "Production line").addEffect(new Blueprint()).addRecipe(
                new Object[][] { { null, ComponentTypes.SIMPLE_PCB.getItemStack(), null },
                        { ComponentTypes.ADVANCED_PCB.getItemStack(), Items.redstone,
                                ComponentTypes.ADVANCED_PCB.getItemStack() },
                        { ComponentTypes.REINFORCED_METAL.getItemStack(), ComponentTypes.BLANK_UPGRADE.getItemStack(),
                                ComponentTypes.REINFORCED_METAL.getItemStack() } });

        new AssemblerUpgrade(10, "Cart Deployer").addEffect(new Deployer()).addRecipe(
                new Object[][] { { Items.iron_ingot, Blocks.rail, Items.iron_ingot },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Blocks.piston,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(11, "Cart Modifier").addEffect(new Disassemble()).addRecipe(
                new Object[][] { { Items.iron_ingot, null, Items.iron_ingot },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Blocks.anvil,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(12, "Cart Crane").addEffect(new Transposer()).addRecipe(
                new Object[][] { { Blocks.piston, Blocks.rail, Blocks.piston },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Items.iron_ingot,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { null, ComponentTypes.BLANK_UPGRADE.getItemStack(), null } });

        new AssemblerUpgrade(13, "Redstone Control").addEffect(new Redstone()).addRecipe(
                new Object[][] {
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), Items.repeater,
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { Blocks.redstone_torch, ComponentTypes.ADVANCED_PCB.getItemStack(), Blocks.redstone_torch },
                        { Items.redstone, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.redstone } });

        new AssemblerUpgrade(14, "Creative Mode").addEffect(new WorkEfficiency(10000.00F))
                .addEffect(new FuelCost(-1.00F));

        AssemblerUpgrade demolisher = new AssemblerUpgrade(15, "Quick Demolisher").addEffect(new TimeFlatRemoved(-8000))
                .addRecipe(
                        new Object[][] {
                                { Blocks.obsidian, ComponentTypes.REINFORCED_METAL.getItemStack(), Blocks.obsidian },
                                { ComponentTypes.REINFORCED_METAL.getItemStack(), Blocks.iron_block,
                                        ComponentTypes.REINFORCED_METAL.getItemStack() },
        ...
        new AssemblerUpgrade(17, "Manager Bridge").addEffect(new Manager()).addEffect(new TimeFlatCart(200)).addRecipe(
                new Object[][] { { Items.iron_ingot, Items.ender_pearl, Items.iron_ingot },
                        { ComponentTypes.SIMPLE_PCB.getItemStack(), ModBlocks.EXTERNAL_DISTRIBUTOR.getBlock(),
                                ComponentTypes.SIMPLE_PCB.getItemStack() },
                        { Items.iron_ingot, ComponentTypes.BLANK_UPGRADE.getItemStack(), Items.iron_ingot } });

        new AssemblerUpgrade(18, "Thermal Engine Upgrade").addEffect(new ThermalFuel()).addEffect(new FuelCost(0.05F))
                .addRecipe(
                        new Object[][] {
                                { Blocks.nether_brick, ComponentTypes.ADVANCED_PCB.getItemStack(),
                                        Blocks.nether_brick },
                                { Blocks.piston, Blocks.furnace, Blocks.piston },
                                { Blocks.obsidian, ComponentTypes.BLANK_UPGRADE.getItemStack(), Blocks.obsidian } });

        new AssemblerUpgrade(19, "Solar Panel Upgrade").addEffect(new Solar()).addRecipe(
                new Object[][] {
                        { ComponentTypes.SOLAR_PANEL.getItemStack(), ComponentTypes.SOLAR_PANEL.getItemStack(),
    ...
    public static void initSides(IIconRegister register) {
        ...
        for (AssemblerUpgrade upgrade : getUpgradesList()) {
            if (!used.contains(upgrade.sideTexture)) {
                sides.put(
                        (byte) upgrade.sideTexture,
                        register.registerIcon(
                                StevesCarts.instance.textureHeader + ":upgrade_side_" + upgrade.sideTexture + "_icon"));
    ...
    public void createIcon(IIconRegister register) {
        icon = register.registerIcon(
                StevesCarts.instance.textureHeader + ":" + getRawName().replace("_upgrade", "") + "_icon");
    }
